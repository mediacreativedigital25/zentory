    ...
    <div className="bg-white rounded-md shadow-2xl overflow-hidden max-w-lg w-full border border-indigo-50">
      <div className="bg-indigo-600 p-8 text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="w-12 h-12 bg-white/20 rounded-md flex items-center justify-center mb-6 backdrop-blur-sm">
      ...
      <div className="p-8 space-y-6">
        <div className="space-y-4">
          <div className="flex items-start gap-4 p-4 bg-amber-50 rounded-md border border-amber-100">
          ...
          <div className="p-6 bg-white rounded-md border border-gray-100 flex items-center justify-between">
            <div>
