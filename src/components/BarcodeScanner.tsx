      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          ...
          >
            ...
            <div className="p-6">
              <div id="reader" className="w-full overflow-hidden rounded-md border-2 border-dashed border-gray-200"></div>
            ...
            <div className="p-4 bg-gray-50 flex justify-center">
              <button
                onClick={onClose}
                className="px-6 py-2 bg-white border border-gray-200 rounded-md text-gray-600 font-medium hover:bg-gray-100 transition-all"
              >
                Batal
              </button>
            </div>
