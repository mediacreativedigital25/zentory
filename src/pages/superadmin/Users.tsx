          ...
          <div className="flex items-center space-x-4">
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 border border-gray-200 rounded-md text-sm outline-none focus:ring-2 focus:ring-indigo-500 w-64"
              />
            </div>
            <select
              value={userFilter}
              onChange={(e) => setUserFilter(e.target.value as any)}
              className="p-2 border border-gray-200 rounded-md text-sm outline-none focus:ring-2 focus:ring-indigo-500"
            >
