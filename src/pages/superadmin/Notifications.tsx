  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      <div className="flex items-center gap-4 bg-white p-6 rounded-md shadow-sm border border-gray-100">
        <div className="p-3 bg-indigo-50 text-indigo-600 rounded-md flex items-center gap-2">
      ...
      <form onSubmit={handleSave} className="space-y-8">
        ...
        <div className="bg-white p-8 rounded-md shadow-sm border border-gray-100 space-y-6">
          ...
          <div className="flex items-center gap-3 p-4 bg-green-50 rounded-md border border-green-100">
            <input
              type="checkbox"
              id="isEmailActive"
        ...
        <div className="pt-2">
          <button
            type="submit"
            disabled={saving}
            className="w-full md:w-auto px-8 py-3 bg-indigo-600 text-white rounded-md font-bold flex items-center justify-center shadow-lg hover:bg-indigo-700 transition disabled:opacity-50"
          >
