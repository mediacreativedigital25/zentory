    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
      <div className="bg-white p-8 rounded-md shadow-xl max-w-md w-full text-center space-y-6 border border-gray-100">
        ...
        <div className="pt-6 space-y-3">
          <Link
            to="/"
            className="inline-flex items-center justify-center w-full px-6 py-4 bg-indigo-600 text-white rounded-md font-bold hover:bg-indigo-700 transition-all shadow-xl shadow-indigo-100 group"
          >
