    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="p-8 md:p-12 relative z-10">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
                ...
                <button 
                  ...
                  className="px-8 py-4 bg-gray-900 text-white rounded-md font-black text-sm hover:bg-black transition-all shadow-xl active:scale-95 flex items-center gap-2"
                >
                  UPGRADE PAKET
        ...
        <div className="space-y-6">
          ...
          <div className="bg-indigo-600 rounded-md shadow-xl shadow-indigo-100 p-8 text-white relative overflow-hidden">
            ...
            <button 
              onClick={() => navigate('/pricing')}
              className="w-full py-4 bg-white text-indigo-600 rounded-md font-black text-sm hover:bg-indigo-50 transition-all active:scale-95"
            >
              LIHAT PILIHAN PAKET
            </button>
          </div>
