...
export default function Stock() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row gap-4 bg-white p-4 rounded-md shadow-sm border border-gray-100">
        ...
        <div className="flex flex-wrap gap-2">
          <select
            ...
            className="px-3 py-2 border border-gray-200 rounded-md text-sm outline-none focus:ring-2 focus:ring-indigo-500 bg-white font-medium"
          >
                  ...
                  <tr className="hover:bg-white/50 transition-colors group border-b border-gray-50 items-center">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-md overflow-hidden bg-white border border-gray-100 shrink-0">
                          <img
                ...
                <div className="text-center">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <button
                      ...
                      className="flex flex-col items-center justify-center p-6 rounded-md border-2 border-gray-100 hover:border-indigo-600 hover:bg-indigo-50 transition-all group"
                    >
                    ...
                    <button
                      ...
                      className="flex flex-col items-center justify-center p-6 rounded-md border-2 border-gray-100 hover:border-green-600 hover:bg-green-50 transition-all group"
                    >
